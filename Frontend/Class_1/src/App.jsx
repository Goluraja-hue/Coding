...
const App = () => {
  ...
  return (
    ...
    <div className='flex gap-25 bg-black w-screen h-screen  item-center justify-center px-10 py-10 '>
   ...
   <div className='text-black'>
    <div className='w-60 h-100 rounded-[10px] bg-gray-400'>
        ...
        <main className='border w-58 mt-2 h-86 p-2 overflow-y-scroll scrollbar-hide scroll-hide ml-1 mr-0.5 rounded bg-amber-700   '>
            {allUsers.map((elem, index) => (
                <div key={index} className='flex pl-1  gap-2 mt-2.5 items-center border  '>
                    <div><img src={elem.Image} alt="" className='w-10 rounded-2xl h-8 object-center object-cover ' /></div>
